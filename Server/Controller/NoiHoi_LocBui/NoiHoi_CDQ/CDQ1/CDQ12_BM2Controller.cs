...
namespace Server.Controllers
{
    ...
    [ApiController]
    public class CDQ12_BM2Controller : ControllerBase
    {
        private readonly NMCD2Context _context;

        public CDQ12_BM2Controller(NMCD2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> GetData_CDQ12_BM2(DateTime? begind, DateTime? endd, string sortOrder = "desc")
        {
            ...
            var query = _context.BmBomCdq12s
            ...
            return Ok(new ApiResponse<List<BmBomCdq12>>
            {
                Status = true,
