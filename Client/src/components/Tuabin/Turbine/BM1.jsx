              ...
              <tr>
                {row2.map((item, index) => (
                  <th
                    ...
                    className={clsx(
                      'sticky top-[50px] z-10 bg-white min-w-[50px] max-w-[50px] px-1  text-center align-middle border border-gray-700',
                      item.vertical
              ...
              <tr>
                {row3.map((col, index) => (
                  <th
                    ...
                    colSpan={col.colSpan}
                    className={clsx(
                      'sticky top-[159px] z-20 bg-white',
                      'min-w-[60px] max-w-[60px] px-1 text-[10px] text-center align-middle',
